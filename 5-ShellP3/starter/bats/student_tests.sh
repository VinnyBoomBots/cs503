...
# Taken from 4-ShellP2 assignment_tests.sh.
...
# Modified from 3-ShellP1's test.sh.
...
@test "Single-pipe test" {
    run ./dsh <<EOF                
echo "My name is Vince" | wc -w
exit
EOF
...
@test "Handling nonexistent commands" {
    run ./dsh <<EOF                
fdsa
exit
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="dsh3>Commandnotfounddsh3>dsh3>cmdloopreturned0"
